...
- Provide a root level release summary that matches the existing pattern for top level documents such as `README.md`.
...
- Mirror the release information in the documentation site because the repository already uses both top level documents and `site/content/docs` pages.
