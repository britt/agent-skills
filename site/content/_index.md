...
| [Project Foundations (Bundle)]({{< relref "skills/project-foundations.md" >}}) | Establish and repair project foundations, then turn a concept into a diagrammed, story-driven plan with supported coding agents |
