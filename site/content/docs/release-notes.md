...
* Shifted Claude.ai distribution away from release zip files in a breaking change, so it now requires cloning the repository and uploading individual skill directories instead of downloading zip archives.